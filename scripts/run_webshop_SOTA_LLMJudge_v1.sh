...
# alpha=0.5, decomposer=judge (gpt-4o-mini, cache /vol/cache/judge.sqlite, budget 5000).
# seed=31, rounds=10, eps=80. Requires OpenAI key via Modal Secret "openai-secret".
